%% Input-Output Nonlinear Model Predictive Control for Rabbit (planar 5-link walker)
%   Trajectory Tracking
...
% Saturate the torque
constr_info.torque = struct('sat',8);
