function [mpc_info] = Formulate_NLP_TrajectoryTracking(mpc_info,n_x,n_u,f_nonlinear,E_nonlinear,H_nonlinear,use_descriptor,param)
% Formulate NLP
...
for i = 1:mpc_info.N
    ...
    [X_dec_all{i},U_dec_all{i},P_dec_all{i},obj_all{i},g_dec_all{i}] = Objective_Constraints_Nonlinear(DT,N,n_x,n_u,f_nonlinear,E_nonlinear,H_nonlinear,use_descriptor,param);
