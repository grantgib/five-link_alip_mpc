...
x_init = [param.gait(1).states.x(:,3); param.gait(1).states.dx(:,3)];
...
tic
[f_nonlinear_partial,ddq_func,J_c,dJ_c,E_nonlinear,H_nonlinear,n_q,n_x,n_u] = Generate_Dynamics_Nonlinear_FreeWrench();
...
tic
[mpc_info] = Formulate_NLP_TrajectoryTracking_FreeWrench(mpc_info,n_q,n_x,n_u,f_nonlinear_partial,ddq_func,J_c,dJ_c,E_nonlinear,H_nonlinear,use_descriptor,param);
...
[x_traj,u_traj,x_traj_all,t_all,mpciter,args] = ...
    ...
    f_nonlinear_partial,n_x,n_u,mpc_info);
