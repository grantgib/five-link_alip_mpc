 ...
 * Tue 17 Mar 2020 21:36:30 GMT-04:00
 */
...
{
  double t298;
  t298 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t298 + var1[0];
  p_output1[2]=t298 - 1.*var1[0];
  p_output1[3]=t298 + var1[1];
  p_output1[4]=t298 - 1.*var1[1];
}
