 ...
 * Wed 11 Dec 2019 12:57:15 GMT-05:00
 */
...
{
  double t1087;
  t1087 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t1087 + var1[0];
  p_output1[2]=t1087 - 1.*var1[0];
  p_output1[3]=t1087 + var1[1];
  p_output1[4]=t1087 - 1.*var1[1];
}
