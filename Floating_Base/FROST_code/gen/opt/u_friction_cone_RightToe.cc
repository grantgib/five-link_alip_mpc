 ...
 * Fri 17 Apr 2020 14:54:00 GMT-04:00
 */
...
{
  double t1127;
  t1127 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t1127 + var1[0];
  p_output1[2]=t1127 - 1.*var1[0];
  p_output1[3]=t1127 + var1[1];
  p_output1[4]=t1127 - 1.*var1[1];
}
