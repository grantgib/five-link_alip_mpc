 ...
 * Sun 29 Mar 2020 00:51:34 GMT-04:00
 */
...
{
  double t2061;
  t2061 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t2061 + var1[0];
  p_output1[2]=t2061 - 1.*var1[0];
  p_output1[3]=t2061 + var1[1];
  p_output1[4]=t2061 - 1.*var1[1];
}
