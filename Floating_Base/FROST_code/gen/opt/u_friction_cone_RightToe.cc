 ...
 * Wed 25 Mar 2020 22:53:37 GMT-04:00
 */
...
{
  double t952;
  t952 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t952 + var1[0];
  p_output1[2]=t952 - 1.*var1[0];
  p_output1[3]=t952 + var1[1];
  p_output1[4]=t952 - 1.*var1[1];
}
