 ...
 * Wed 1 Apr 2020 22:02:56 GMT-04:00
 */
...
{
  double t242;
  t242 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t242 + var1[0];
  p_output1[2]=t242 - 1.*var1[0];
  p_output1[3]=t242 + var1[1];
  p_output1[4]=t242 - 1.*var1[1];
}
