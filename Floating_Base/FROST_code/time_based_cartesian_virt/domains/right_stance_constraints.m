...
%     addConstraint(nlp, 'average_velocity', 'last', avg_vel_cstr);
    ...
    addNodeConstraint(nlp, swingFootHeight, {'x'}, floor(nlp.NumNode/2), 0.14*1.5, 0.14*2.5,'Linear');
    
    % Step Length
    swingFootLength = SymFunction('swing_foot_length',nlp.Plant.EventFuncs.leftFootX.ConstrExpr,{X});
    addNodeConstraint(nlp,swingFootLength,{'x'},nlp.NumNode,0.3,Inf,'Linear');
