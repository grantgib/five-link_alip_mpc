 ...
 * Thu 28 Jan 2021 16:26:57 GMT-05:00
 */
...
{
  double t299;
  t299 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t299 + var1[0];
  p_output1[2]=t299 - 1.*var1[0];
  p_output1[3]=t299 + var1[1];
  p_output1[4]=t299 - 1.*var1[1];
}
