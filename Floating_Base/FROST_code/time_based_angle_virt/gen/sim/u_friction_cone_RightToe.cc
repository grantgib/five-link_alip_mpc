 ...
 * Wed 3 Feb 2021 21:34:42 GMT-05:00
 */
...
{
  double t1019;
  t1019 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t1019 + var1[0];
  p_output1[2]=t1019 - 1.*var1[0];
  p_output1[3]=t1019 + var1[1];
  p_output1[4]=t1019 - 1.*var1[1];
}
