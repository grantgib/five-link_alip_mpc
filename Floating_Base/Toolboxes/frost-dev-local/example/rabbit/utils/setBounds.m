...
bounds.RightStance.time.tf.lb = 0.10;
bounds.RightStance.time.tf.ub = 0.25;
bounds.RightStance.time.tf.x0 = 0.25;

bounds.RightStance.time.duration.lb = 0.10;
bounds.RightStance.time.duration.ub = 0.25;
bounds.RightStance.time.duration.x0 = 0.25;
