...
%         value(i) = eventfuncs(i).calcConstraint(dep_val{:},0.05*params.ptime(1));
   posStance=stanceFootPos(dep_val{:});
   hgt=posStance(3)+0.05;
 value(i) = u_hgtRightStance(dep_val{:},hgt);
    end
