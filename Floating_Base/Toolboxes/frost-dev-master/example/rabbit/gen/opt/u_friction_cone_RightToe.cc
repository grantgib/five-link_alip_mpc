 ...
 * Wed 26 Aug 2020 15:03:34 GMT-04:00
 */
...
{
  double t3256;
  t3256 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t3256 + var1[0];
  p_output1[2]=t3256 - 1.*var1[0];
  p_output1[3]=t3256 + var1[1];
  p_output1[4]=t3256 - 1.*var1[1];
}
