 ...
 * Sun 19 Apr 2020 19:53:20 GMT-04:00
 */
...
{
  double t38;
  t38 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t38 + var1[0];
  p_output1[2]=t38 - 1.*var1[0];
  p_output1[3]=t38 + var1[1];
  p_output1[4]=t38 - 1.*var1[1];
}
