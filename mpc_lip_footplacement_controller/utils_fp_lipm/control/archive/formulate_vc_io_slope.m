...
pos_ground_com = pos_com_world - pos_ground;
...
hd = [
    ...
    4*z_mid*(s-0.5)^2 + (p_ground_com_des - z_mid)
    ];
...
f_ha = Function('f_ha',{x,kx,ground_height_init},{ha});
f_ha_dot = Function('f_ha_dot',{x,kx,ground_height_init},{ha_dot});
f_ha_ddot = Function('f_ha_ddot',{x,u,w,kx,ground_height_init},{ha_ddot});
f_hd = Function('f_hd',{s,sdot,torso_pitch_des,p_ground_com_des,p_sw_com_init,p_sw_com_des,z_mid},{hd});
f_hd_dot = Function('f_hd_dot',{s,sdot,torso_pitch_des,p_ground_com_des,p_sw_com_init,p_sw_com_des,z_mid},{hd_dot});
f_hd_ddot = Function('f_hd_ddot',{s,sdot,torso_pitch_des,p_ground_com_des,p_sw_com_init,p_sw_com_des,z_mid},{hd_ddot});

% IO controller
f_uIO = Function('f_uIO',{x,s,sdot,torso_pitch_des,p_ground_com_des,p_sw_com_init,p_sw_com_des,z_mid,kx,ground_height_init},{uIO});
