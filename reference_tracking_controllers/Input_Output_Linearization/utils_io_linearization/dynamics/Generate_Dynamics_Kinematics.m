...
%       ha = [torso angle, relative hip height, relative swing foot x, relative swing foot z]'
%       y = actual output - desired output;
% Virtual constraints
ha = [q(3);
      q(2)-pos_stance(2);
      pos_swing(1)-pos_stance(1);
      pos_swing(2)-pos_stance(2)];  % actual virtual constraint output
% ha = [q(3); q(4); q(3)+q(4)+q(5)/2; q(3)+q(6)+q(7)/2]
