 ...
 * Tue 9 Feb 2021 15:58:56 GMT-05:00
 */
...
{
  double t4087;
  t4087 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t4087 + var1[0];
  p_output1[2]=t4087 - 1.*var1[0];
  p_output1[3]=t4087 + var1[1];
  p_output1[4]=t4087 - 1.*var1[1];
}
