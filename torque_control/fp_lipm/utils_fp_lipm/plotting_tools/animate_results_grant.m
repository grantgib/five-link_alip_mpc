...
com = scatter(p_com_traj(1,1),p_com_traj(2,1),500);
...
set(com,'MarkerFaceColor','g','MarkerFaceAlpha',0.5);
...
for i = 1:size(x_traj,2)
    ...
    set(com,...
        'XData',p_com_traj(1,i),...
        'YData',p_com_traj(2,i));
