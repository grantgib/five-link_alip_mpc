 ...
 * Wed 10 Feb 2021 16:00:53 GMT-05:00
 */
...
{
  double t4143;
  t4143 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t4143 + var1[0];
  p_output1[2]=t4143 - 1.*var1[0];
  p_output1[3]=t4143 + var1[1];
  p_output1[4]=t4143 - 1.*var1[1];
}
