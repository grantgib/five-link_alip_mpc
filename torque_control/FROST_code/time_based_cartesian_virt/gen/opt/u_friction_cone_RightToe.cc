 ...
 * Mon 8 Feb 2021 04:15:40 GMT-05:00
 */
...
{
  double t62;
  t62 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t62 + var1[0];
  p_output1[2]=t62 - 1.*var1[0];
  p_output1[3]=t62 + var1[1];
  p_output1[4]=t62 - 1.*var1[1];
}
