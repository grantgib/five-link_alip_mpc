 ...
 * Thu 4 Feb 2021 10:19:47 GMT-05:00
 */
...
{
  double t3577;
  t3577 = 0.7071065623731627*var1[2]*var2[0];
  p_output1[0]=var1[2];
  p_output1[1]=t3577 + var1[0];
  p_output1[2]=t3577 - 1.*var1[0];
  p_output1[3]=t3577 + var1[1];
  p_output1[4]=t3577 - 1.*var1[1];
}
